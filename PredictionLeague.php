...
<body>
    ...
    <div class="containernav flex"><!--class "containernav" is a box inside the header where all the content is. class "flex" makes the content change size when website is smaller -->
      ...
      <nav>
        <ul class="smA"><!--sets the font size class-->
          ...
          <li><a class="active" href="PredictionLeague.php">Prediction League</a></li><!-- links to prediction league page and is a button-->
          <li><a href="PremierLeague.php">Premier League</a></li><!--links to home page and is a button this is active because this is the premier league page -->
  ...
  <div class="flex">
  <div class="PLHeader">
    <h1>In order to predict you need to <a href ="Index.php" style="color:#000000;"><b>log in</b></a> or create an <a href="signup.php" style ="color:#000000;"><b>account</b></a>
  </div>
</div>    
    ...
    <div class="containernav grid grid-3"> <!--class "containernav" is a box inside the footer where all the content is. class "grid" is a grid in the footer for each individual section. class "grid-3" is space for each individual section-->
      ...
      <nav> <!--section for links/buttons-->
        <ul class="footernav smA">  <!--class "footernav" that sets it to the right. class "smA" is a font size-->
          ...
          <li><a class="active" href="PredictionLeague.php">Prediction League</a></li> <!--footer prediction league button-->
