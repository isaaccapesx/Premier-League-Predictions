...
<head>
  ...
  <title>PLP | Prediction League</title><!--Title at the top so the user know which page they are on-->
</head>
<body>
    ...
    <div class="containernav flex"><!--class "containernav" is a box inside the header where all the content is. class "flex" makes the content change size when website is smaller -->
      ...
      <nav>
        <ul class="smA"><!--sets the font size class-->
          ...
          <li><a class="active" href="PredictionLeague2.php">Prediction League</a></li><!-- links to prediction league page and is a button-->
          <li><a href="PremierLeague2.php">Premier League</a></li><!--links to home page and is a button this is active because this is the premier league page -->
...
<section class="">
  <div class="flex"> <!--class "flex" makes the content change size when website is smaller -->
    <div class="PLHeader2"> <!--class "PLHeader2" is just a style class-->
      ...
      <button class ="LeagueButton1"><a href="createleague.php">Create league</a></button> <!-- class "LeagueButton1" is a style for the button-->
      <button class="LeagueButton2"><a href="joinleague.php">Join league</button></a> <!-- class "LeagueButton2" is a class for the second button which has padding -->
    </div>
  </div>
</section>
    ...
    <div class="containernav grid grid-3"> <!--class "containernav" is a box inside the footer where all the content is. class "grid" is a grid in the footer for each individual section. class "grid-3" is space for each individual section-->
      ...
      <nav> <!--section for links/buttons-->
        <ul class="footernav smA">  <!--class "footernav" that sets it to the right. class "smA" is a font size-->
          ...
          <li><a href="YourPredictions2.php">Your Predictions</a></li>  <!--footer your prediction buttons-->
          <li><a class="active" href="PredictionLeague2.php">Prediction League</a></li> <!--footer prediction league button-->
