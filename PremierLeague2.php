...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Gothic+A1&display=swap" rel="stylesheet"> <!--refers a font style website-->
  ...
  <title>PLP | Premier League</title> <!--Title at the top so the user know which page they are on-->
</head>
<body>
    ...
    <div class="containernav flex"><!--class "containernav" is a box inside the header where all the content is. class "flex" makes the content change size when website is smaller -->
      ...
      <nav>
        <ul class="smA"><!--sets the font size class-->
          ...
          <li><a class="active" href="PremierLeague2.php">Premier League</a></li><!--links to home page and is a button this is active because this is the premier league page -->
  ...
  <section class="">
  <div class="flex"> <!--class "flex" makes the content change size when website is smaller -->
    <div class="PLHeader2"> <!--class "PLHeader2" is just a style class-->
      <h1>Play against your friends</h1>
      <h2>Create a private league or join a current league</h2>
      <button class ="LeagueButton1"><a href="createleague.php">Create league</a></button>
      <button class="LeagueButton2"><a href="joinleague.php">Join league</button></a>
    </div>
  </div>
</section>
  ...
  <section class="Size">
    <div class="fwp-embed" data-color="#3f1052" data-font-size="17px" data-border-color="#3f1052" data-heading-color="#3f1052" data-url="premier-league/league-table"></div>
    ...
    <div class="containernav grid grid-3"> <!--class "containernav" is a box inside the footer where all the content is. class "grid" is a grid in the footer for each individual section. class "grid-3" is space for each individual section-->
      ...
      <nav> <!--section for links/buttons-->
        <ul class="footernav smA">  <!--class "footernav" that sets it to the right. class "smA" is a font size-->
          ...
          <li><a href="PredictionLeague2.php">Prediction League</a></li> <!--links to prediction league page and is a button -->
          <li><a class="active" href="PremierLeague.php2">Premier League</a></li> <!--links to premier league page and is a button this is active because this is the premier league page -->
          <li><a href="FAQ2.php">FAQ</a></li> <!--links to faq page and is a button -->
        </ul>
      </nav>
    </div>
  </div>
