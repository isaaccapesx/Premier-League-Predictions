...
<body>
    ...
    <div class="containernav flex"><!--class "containernav" is a box inside the header where all the content is. class "flex" makes the content change size when website is smaller -->
      ...
      <nav>
        <ul class="smA"><!--sets the font size class-->
          <li><a class="active" href="Index.php">Home</a></li><!--links to home page and is a button this is active because this is the home page-->
          <li><a href="YourPredictions.php">Your Predictions</a></li><!-- links to your prediction page and is a button -->
          <li><a href="PredictionLeague.php">Prediction League</a></li><!-- links to prediction league page and is a button-->
          <li><a href="PremierLeague.php">Premier League</a></li><!--links to home page and is a button-->
  ...
  <section>
    ...
    <div class="HomeBanner"> <!--blue banner at the top for the sign in part-->
      <h1>Sign in</h1> <!--text in the banner -->
      <form action ="login.php" method="post"> <!-- goes to login script -->
        <label for="uname" style ="font-size:28px"><b>Username</b></label> <!--allows users to enter the email-->
        <input class ="input" type="text" id="uname" name="uname">
        <label for="password"style ="font-size:28px;"><b>Password</b></label> <!--allows users to enter password-->
        <input class="input" type="password" id="password" name="password">
        <h2><a href="signup.php" style="color: #ffffff;">Register here</a></h2>
        <button class="signupbutton" style="color: #ffffff;">Enter</button><!--class "button" is the size of the button. class "enter" makes the button green. -->
      </form>
    </div>
    <br>
    <br>
    <div class="fwp-embed" data-font-size="17px" data-border-color="#3f1052" data-heading-color="#3f1052" data-url="news"></div> <!--news articles from another website that gets updated-->
    ...
    <div class="containernav grid grid-3"> <!--class "containernav" is a box inside the footer where all the content is. class "grid" is a grid in the footer for each individual section. class "grid-3" is space for each individual section-->
      ...
      <nav><!--section for links/buttons-->
        <ul class="footernav smA">
          <li><a class="active" href="Index.php">Home</a></li><!--links to home page and is a button this is active because this is the premier league page -->
          <li><a href="YourPredictions.php">Your Predictions</a></li><!--links to your predictions page and is a button -->
          <li><a href="PredictionLeague.php">Prediction League</a></li><!--links to prediction league page and is a button -->
