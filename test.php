...
<head>
  ...
  <title>PLP | Test </title> <!--Title at the top so the user know which page they are on-->
</head>
<body>
    ...
    <div class="containernav flex"><!--class "containernav" is a box inside the header where all the content is. class "flex" makes the content change size when website is smaller -->
      ...
      <nav>
        <ul class="smA"> <!--sets the font size class-->
          ...
          <li><a class="active" href="YourPredictions.php">Your Predictions</a></li><!-- links to your prediction page and is a button this is active because this is the premier league page-->
